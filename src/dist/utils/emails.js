...
exports.verifyMail = exports.OTPMail = void 0;
...
const OTPMail = (user, tokenID) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const data = path_1.default.join(__dirname, "../views/otp.ejs");
...
const verifyMail = (user, tokenID) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const getAccess = (yield oAuth.getAccessToken()).token;
        const transport = nodemailer_1.default.createTransport({
            service: "gmail",
